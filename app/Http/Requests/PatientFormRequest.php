...
class PatientFormRequest extends FormRequest
{
 ...
 public function rules()
 {
  return [
   ...
   'tratamiento_medico_descp'    => ['string', 'max:255'],
   'alergias'                    => ['required', 'string', 'max:255'],
   'alergias_descp'              => ['string', 'max:255'],
   'medicamentos_que_toma'       => ['required', 'string', 'max:255'],
   'medicamentos_que_toma_descp' => ['string', 'max:255'],
   'antibioticos'                => ['required', 'string', 'max:255'],
   'antibioticos_descp'          => ['string', 'max:255'],
   'enfermo_del_corazon'         => ['required', 'string', 'max:255'],
   'enfermo_del_corazon_descp'   => ['string', 'max:255'],
   'hepatitis'                   => ['required', 'string', 'max:255'],
   'hepatitis_descp'             => ['string', 'max:255'],
   'diabetes'                    => ['required', 'string', 'max:255'],
   'diabetes_descp'              => ['string', 'max:255'],
   'sifilis'                     => ['required', 'string', 'max:255'],
   'sifilis_descp'               => ['string', 'max:255'],
   'desmayos'                    => ['required', 'string', 'max:255'],
   'desmayos_descp'              => ['string', 'max:255'],
   'sangra_mucho'                => ['required', 'string', 'max:255'],
   'sangra_mucho_descp'          => ['string', 'max:255'],
   'cicratizar_heridas'          => ['required', 'string', 'max:255'],
   'cicratizar_heridas_descp'    => ['string', 'max:255'],
   'sida'                        => ['required', 'string', 'max:255'],
   'sida_descp'                  => ['string', 'max:255'],
