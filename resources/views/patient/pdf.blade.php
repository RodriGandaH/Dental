        ...
        <tbody>
            <tr>
                ...
                <td class=" numero-columna">
                    ...
                    <div
                        style="display: inline-block; border: 1px solid black; border-radius: 2px; padding: 0 5px; width:70px; margin-left:10px;">
                        <span>451348</span>
                    </div>
                </td>
            </tr>
        ...
        <table
            ...
            <tbody>
                <tr>
                    ...
                    <td
                        style="border-left: 1px solid black; border-right: 1px solid black; border-bottom: 1px solid black; padding: 2px;width: 5%;">
