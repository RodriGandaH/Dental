<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight text-center">
            {{ __('Editar tratamiento de ') }} <span>{{$patient->nombre}}</span>
        </h2>
    </x-slot>
    <div class="py-2">
            ...
            <div class="py-4 px-4 bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div class="container">
                    ...
                    <form method="POST" class="m-3"
                        action="{{ route('tratamiento.update', ['patient' => $patient, 'tratamiento' => $tratamiento]) }}">
                        @method('PATCH')
                        ...
                        <div class="grid md:grid-cols-12 sm:grid-cols-1 gap-2">
                            <div class="md:col-span-3 sm:col-span-1">
                                ...
                                <textarea id="diente" rows="2" name="diente"
                                    class="block mt-1 w-full text-sm text-gray-900   border border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">{{old('diente', $tratamiento->diente)}}</textarea>
                            ...
                            <div class="md:col-span-4 sm:col-span-1">
                                ...
                                <textarea id="diagnostico" rows="2" name="diagnostico"
                                    class="block mt-1 w-full text-sm text-gray-900   border border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">{{old('diagnostico', $tratamiento->diagnostico)}}</textarea>
                                @error('diagnostico')
                                <span class="text-sm text-red-600 space-y-1">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="md:col-span-1 sm:col-span-1 flex flex-col items-center">
                                ...
                                <input id="rx" type="checkbox" value="1" name="rx"
                                    class="mt-2 w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 mx-auto"
                                    {{ $tratamiento->rx ? 'checked' : '' }}>

                            </div>
                            <div class="md:col-span-3 sm:col-span-1">
                                <x-input-label for="tratamiento" :value="__('Tratamiento')" />
                                <textarea id="tratamiento" rows="2" name="tratamiento"
                                    class="block mt-1 w-full text-sm text-gray-900   border border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">{{old('tratamiento', $tratamiento->tratamiento)}}</textarea>
                                @error('tratamiento')
                                <span class="text-sm text-red-600 space-y-1">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="grid md:grid-cols-12 sm:grid-cols-1 gap-2 mt-4">
                            <div class="md:col-span-3 sm:col-span-1">
                                ...
                                <x-text-input id="fecha_inicio" class="block mt-1 w-full" type="date"
                                    name="fecha_inicio" :value="old('fecha_inicio', $tratamiento->fecha_inicio)" />
                                @error('fecha_inicio')
                                <span class="text-sm text-red-600 space-y-1">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="md:col-span-6 sm:col-span-1">
                                ...
                                <textarea id="observaciones" rows="4" name="observaciones"
                                    ...
                                    placeholder="Escribe las observaciones aqui...">{{old('observaciones', $tratamiento->observaciones)}}</textarea>
                            </div>
                        </div>
                        <br>
